...
<div class="modal-row activity">
    ...
    <div class="row-right-side">
        ...
        $sql = $db->query(
            "SELECT ActivityID, Text, EmployeeID, Type, DateTime, File
            FROM Activity
            WHERE TaskID = :TaskId
                    ...
                    case 'Comment' :?>
                        <div class="comment" id="coment-<?= $sql[$i]['ActivityID'] ?>">
                            ...
                            <div class="comment-body">
                                ...
                                <?php 
                                $start = explode('[', $sql[$i]['File'])[0];
                                $end = explode(']', $sql[$i]['File']);

                                if ($sql[$i]['File'] != NULL) : ?>
                                    <a href="./documents/tasks/<?= $id ?>/comments/<?= $sql[$i]['File'] ?>" class="comment-text text">
                                        <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.44387 5.55672C6.9433 5.05636 6.2645 4.77527 5.55672 4.77527C4.84895 4.77527 4.17015 5.05636 3.66957 5.55672L1.78181 7.44387C1.28123 7.94446 1 8.6234 1 9.33133C1 10.0393 1.28123 10.7182 1.78181 11.2188C2.28239 11.7194 2.96133 12.0006 3.66927 12.0006C4.3772 12.0006 5.05614 11.7194 5.55672 11.2188L6.5003 10.2752" stroke="#565252" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M5.55664 7.44387C6.05722 7.94424 6.73602 8.22533 7.44379 8.22533C8.15157 8.22533 8.83037 7.94424 9.33094 7.44387L11.2187 5.55672C11.7193 5.05614 12.0005 4.3772 12.0005 3.66927C12.0005 2.96133 11.7193 2.28239 11.2187 1.78181C10.7181 1.28123 10.0392 1 9.33125 1C8.62331 1 7.94438 1.28123 7.44379 1.78181L6.50022 2.72539" stroke="#565252" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <?= $start.$end[count($end) - 1] ?>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
