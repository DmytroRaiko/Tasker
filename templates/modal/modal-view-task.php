...
<div class="modal-of modal-of-center modal-of-show" id="create-task-modal-<?= $id ?>">
    <form class="modal task-modal-view" modal-id="create-task-modal-<? $id ?>">
            ...
            <div class="modal-left-column modal-column">
                <div class="modal-row">
                    ...
                    <div class="row-right-side">
                        <div class="title-block">
                            <input class="input-iteractive text text-19" type="text" name="task-name-new" id="task-name-new" placeholder="Enter task name">
                        </div>
                    </div>
                ...
                <div class="modal-row">
                    ...
                    <div class="row-right-side">
                        ...
                        <textarea class="text text-14" name="discription-task-new" id="discription-task-new" cols="30" rows="8" placeholder="Enter description..."></textarea>
                    </div>
                ...
                <div class="modal-right-top">
                    ...
                    <div class="block-right-col">
                        <select id="executor-create-task" class="js-select2" name="city" placeholder="Выберите город">
                            ...
                            <option value="369">Medvedeva Katerina</option>	
                            <option value="370">Hluhovtsov Dmitry</option>	
                            <option value="371">АShelehov Daniil</option>	
                        </select>
                    ...
                    <div class="block-notification">
                        <div class="block-notification-left">
                            <input type="checkbox" name="notification-daily-checker" id="notification-daily-checker">
                        </div>
                        <div class="block-notification-right text text-15">
                            ...
                            at 
                            <input class="text-16" type="number" name="notification-daily-time-hours" id="notification-daily-time-hours" min="00" max="23" value="00" placeholder="00">
                            :
                            <input class="text-16" type="number" name="notification-daily-time-minute" id="notification-daily-time-minute" min="00" max="59" value="00" placeholder="00">         
                        </div>
                    </div>
                </div>
                <div class="modal-right-bottom">
                    <div class="block-notification">
                        ...
                        <div class="block-notification-right text text-15">
                            ...
                            at 
                            <input class="text-16" type="number" name="notification-block-time-hours" id="notification-daily-time-hours" min="00" max="23" step="1" value="00" placeholder="00">
                            :
                            <input class="text-16" type="number" name="notification-block-time-minute" id="notification-daily-time-minute" min="00" max="59" step="1" value="00" placeholder="00">         
                        </div>
                    </div>
...
<script>
    $(document).ready( function () {
        $('body').on('submit','.task-modal-view', function (e) {  
            e.preventDefault();
