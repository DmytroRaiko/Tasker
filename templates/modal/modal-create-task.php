...
function modal_create_task ($id, $project, $empl) { 
    global $db;
    ?>

    <div class="modal-of modal-of-center modal-of-show" id="create-task-modal-<?= $id ?>">
        <form class="modal task-modal-create" data-modal-id="create-task-modal-<?= $id ?>">
            <input type="hidden" name="task-parent-id" value="<?= $id ?>" required>
            <input type="hidden" name="task-project-id" value="<?= $project ?>" required>
            <input type="hidden" name="task-employees-id" value="<?= $empl ?>" required>
                ...
                <div class="modal-left-column modal-column">
                    <div class="modal-row">
                        ...
                        <div class="row-right-side">
                            <div class="title-block">
                                <input class="input-iteractive text text-19" type="text" name="task-name-new" id="task-name-new-<?= $id ?>" placeholder="Enter task name" required>
                                <div class="modal-row block-task-checkbox">
                                    <div class="block-task-checkbox-left">
                                        <input type="checkbox" name="have-sub-task" id="have-sub-task">
                                    </div>
                    ...
                    <div class="modal-row">
                        ...
                        <div class="row-right-side">
                            ...
                            <textarea class="text text-14" name="task-discription-new" id="task-discription-new-<?= $id ?>" cols="30" rows="8" placeholder="Enter description..."></textarea>
                        </div>
                    </div>
                ...
                <div class="modal-right-column modal-column">
                    <div class="modal-right-top">
                        ...
                        <div class="block-right-col">
                            <select id="executor-create-task" class="js-select2" name="executor-create-task[]" multiple="multiple">
                                <option value=""></option>
                                <?php 
                                    $query = $db->query(
                                        "SELECT * FROM `employees` WHERE `ManagerID` = :manager",
                                        [
                                            ':manager' => $empl
                                        ]
                                    );
                                    ...
                                    for ($i = 0; $i < count($query); $i++) {
                                        ?>
                                        <option value="<?= $query[$i]['EmployeeID'] ?>"><?= $query[$i]['Name'] . " " . $query[$i]['Surname'] ?></option>
                                        <?php
                                    }
                                ?>
                        ...
                        <div class="block-notification">
                            ...
                            <div class="block-notification-right text text-15">
                                ...
                                at 
                                <input class="text-16" type="time" name="notification-daily-time" id="notification-daily-time" value="00:00" placeholder="00:00" >
                            </div>
                        </div>
                    </div>
                    <div class="modal-right-bottom">
                        <div class="block-notification">
                            <div class="block-notification-left">
                                <input type="checkbox" name="notification-block-checker" id="notification-block-checker">
                            ...
                            <div class="block-notification-right text text-15">
                                <label for="notification-block-checker">
                                    <b>blocking notification on the penultimate day</b>
                                </label>
                                at 
                                <input class="text-16" type="time" name="notification-block-time" id="notification-block-time" value="00:00" placeholder="00:00">
                            </div>
                        </div>
                        <div class="block-button-modal">
                            <button class="text text-21">Create</button>
                        </div>
                    </div>
                </div>
            </div>
