...
function modal_view_notification ($id) { 
    global $db;
            ...
            <div class="modal-body">
                ...
                <div class="modal-right-column modal-column">
                    <div class="modal-right-top">
                        <?php if ($sender && $notification[0]['replyDocuments'] != NULL ||
                                !$sender) { ?>
                            <div class="modal-row">
                                <div class="modal-icon-row">
                                    <label>
                                ...
                                <div class="row-right-side">
                                    ...
                                    <div id="moreUpload">
                                        ...
                                        <?php } else {
                                            $array = json_decode($notification[0]['replyDocuments']);
                        ...
                        <?php } 
                        if ($sender && $notification[0]['replyLinks'] != NULL ||
                                !$sender) { ?>
                            <div class="modal-row">
                                <div class="modal-icon-row">
                                    <label>
                                ...
                                <div class="row-right-side">
                                    ...
                                    <div id="moreUpload-link">
                                        ...
                                        <?php } else { 
                                            $array = json_decode($notification[0]['replyLinks']);
                                            $array_count = count($array);
                                            for ($i=0; $i < $array_count; $i++) { 
                                                ?>
                                                <div class="attachment-block-view">
